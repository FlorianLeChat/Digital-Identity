...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : sam. 19 nov. 2022 à 16:48
...
INSERT INTO `user` (`id`, `email`, `roles`, `password`, `firsname`, `lastname`, `code_badge`, `formation_id`) VALUES
(1, 'brahim.lamjarad@etu.univ-cotedazur.fr', '[]', '$2y$13$ij5t6QqjqIZreiOvBuVdWOadLfnmOkAr2CAiSxl5eJ7TueNkPjO5y', 'Brahim', 'LAMJARAD', 1234, 5);
COMMIT;
