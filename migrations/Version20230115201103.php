 ...
 */
final class Version20230115201103 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE matiere DROP id_matiere');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE matiere ADD id_matiere INT NOT NULL');
    }
}
